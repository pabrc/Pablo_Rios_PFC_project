...
module NIOSIImicro_addr_router_default_decode
  #(
...
module NIOSIImicro_addr_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD2 = log2ceil(64'h1001298 - 64'h1001290); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h1001298;
    ...
    NIOSIImicro_addr_router_default_decode the_default_decode(
    ...
    // ( 0x1001290 .. 0x1001298 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 25'h1001290   ) begin
            src_channel = 33'b100;
