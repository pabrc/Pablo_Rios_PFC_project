...
//   output_name:         NIOSIImicro_rsp_xbar_mux_001
//   NUM_INPUTS:          33
...
module NIOSIImicro_rsp_xbar_mux_001
(
    // ----------------------
    // Sinks
    // ----------------------
    ...
    always @* begin
      ...
      lock[30] = sink30_data[65];
      lock[31] = sink31_data[65];
      lock[32] = sink32_data[65];
    end
