...
module NIOSIImicro_tristate_bridge_0_bridge_0 (
     input  logic clk
    ,input  logic reset
    ,input  logic request
    ,output logic grant
    ...
    ,input  logic[ 0 :0 ] tcs_select_n_to_the_cfi_flash_
    ,output  wire [ 0 :0 ] select_n_to_the_cfi_flash_
 ...
 // ** Output Pin select_n_to_the_cfi_flash_ 
 
    reg                       select_n_to_the_cfi_flash_en_reg;     
  
    always@(posedge clk) begin
	 if( reset ) begin
	   select_n_to_the_cfi_flash_en_reg <= 'b0;
	 end
	 else begin
	   select_n_to_the_cfi_flash_en_reg <= 'b1;
	 end
     end		     
   
 
    reg [ 0 : 0 ] select_n_to_the_cfi_flash__reg;   

     always@(posedge clk) begin
	 select_n_to_the_cfi_flash__reg   <= tcs_select_n_to_the_cfi_flash_[ 0 : 0 ];
      end
          
 
    assign 	select_n_to_the_cfi_flash_[ 0 : 0 ] = select_n_to_the_cfi_flash_en_reg ? select_n_to_the_cfi_flash__reg : 'z ;
