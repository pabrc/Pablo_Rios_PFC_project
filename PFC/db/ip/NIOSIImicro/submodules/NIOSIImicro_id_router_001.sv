...
module NIOSIImicro_id_router_001_default_decode
  #(
  ...
  (output [75 - 70 : 0] default_destination_id,
...
module NIOSIImicro_id_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    NIOSIImicro_id_router_001_default_decode the_default_decode(
